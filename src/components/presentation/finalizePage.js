   ...
   function Finalize(props) {
    ...
    const saveToDatabase= async()=>{
      ...
      if(user.resumeIds!=undefined){
        obj = {...user.resumeIds,[document.id]:{educationSection:educationSection,contactSection:contactSection,document:documentd}}
      }else{
        obj = {[document.id]:{educationSection:educationSection,contactSection:contactSection,document:documentd}}
      }
